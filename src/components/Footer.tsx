        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/catalog/sillas" className="text-gray-400 hover:text-white transition">Sillas</Link></li>
              <li><Link to="/catalog/mesas" className="text-gray-400 hover:text-white transition">Mesas</Link></li>
            </ul>
          </div>
              ...
              {(storeSettings.returnPolicy || storeSettings.terms || storeSettings.privacy) && (
                <>
                  {storeSettings.returnPolicy && (
                    <li><Link to="/policies" className="text-gray-400 hover:text-white transition">Políticas</Link></li>
                  )}
                  {storeSettings.terms && (
