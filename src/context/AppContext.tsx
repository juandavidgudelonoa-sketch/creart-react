...
const defaultProducts: Product[] = [
  // Sillas
  { id: 'silla-elly', name: 'Silla Elly', category: 'sillas', price: 299000, originalPrice: 449000, description: 'Diseño elegante y cómodo', rating: 5, reviews: 15, badge: 'Nuevo', stock: 10, features: ['Madera reforzada', 'Asiento acolchado', 'Peso máx: 120kg'], image: 'https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=400&h=400&fit=crop' },
